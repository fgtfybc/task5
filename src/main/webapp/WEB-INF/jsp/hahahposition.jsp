        ...
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                ...
                <div class="warp-class2">
                    ...
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color">${profession.get(0).rare}</span>家公司需要</div>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    ...
                    <div class="rightWarp">
                        <div class="rightWarp-class">
                            ...
                            <div class="rightWarp-wages">${profession.get(0).payone}/月</div>
                        </div>
                        <div class="rightWarp-class">
                            <div class="rightWarp-year">2-5年</div>
                            <div class="rightWarp-wages">${profession.get(0).paytwo}/月</div>
                        </div>
                        <div class="rightWarp-class border-bottom">
                            <div class="rightWarp-year">5年以上</div>
                            <div class="rightWarp-wages">${profession.get(0).paythree}/月</div>
                        </div>
                    </div>
                </div>
