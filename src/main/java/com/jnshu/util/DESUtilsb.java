...
@Component
public class DESUtilsb {
    private static final Logger log= LogManager.getLogger(DESUtilsb.class);
    //定义加密类型
    ...
    public DESUtilsb() throws Exception {
        this(defaultKey);
    }
     ...
     * @throws Exception
     */
    public DESUtilsb(String strKey) throws Exception {
