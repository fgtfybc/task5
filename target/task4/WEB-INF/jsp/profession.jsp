        ...
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    ...
                    <div class="text">
                        <h4 class="">${profession.get(0).name}</h4>
                        <p class="text-present">${profession.get(0).intro}</p>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">成长周期 <span class="iconfont-color">${profession.get(0).cycle}</span>年</div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color">${profession.get(0).cycle}</span>家公司需要</div>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    ...
                    <div class="rightWarp">
                        <div class="rightWarp-class">
                            ...
                            <div class="rightWarp-wages">${profession.get(0).payfirst}/月</div>
                        </div>
                        <div class="rightWarp-class">
                            <div class="rightWarp-year">2-5年</div>
                            <div class="rightWarp-wages">${profession.get(0).paysecond}/月</div>
                        </div>
                        <div class="rightWarp-class border-bottom">
                            <div class="rightWarp-year">5年以上</div>
                            <div class="rightWarp-wages">${profession.get(0).paythirdly}/月</div>
                        </div>
                    </div>
                </div>

                <div class="warp-class2">
                    <b class="text-b">有176人正在学</b>
                </div>
                <div class="warp-class2">
                    <p class="text-p">${profession.get(0).basics}</p>
                </div>
